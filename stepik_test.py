...
# for checkbox in checkboxes:
#     if checkbox.get_attribute("type") == "checkbox":  # Проверяем тип элемента
#         value = checkbox.get_attribute('value')
#         if value.isdigit() and int(value) in numbers:  # Проверяем что value — число из списка
#             checkbox.click()
#
#
# # Ждем, чтобы кнопка стала активной и нажимаем на неё
# button = browser.find_element(By.CSS_SELECTOR, "input[type='button']")
# button.click()
# time.sleep(1)
